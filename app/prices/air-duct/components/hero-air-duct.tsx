...
const HeroAirDuct = () => {
  ...
  <div className="container z-10">
    <div className=" absolute top-32 sm:top-36 xl:top-60 pl-[15px] md:pl-[30px] xl:pl-[40px]">
      <h2 className='w-full text-black/70 max-w-[680px]  montserrat font-bold text-[18px]  sm:text-[24px] md:text-[36px] lg:text-[40px] xl:text-[46px]'>Save on electricity consumption up to <span className='text-blue-500'>21%</span> on cooling system</h2>
      ...
      <p className='text-black/80 font-medium md:font-normal w-[230px] montserrat text-[12px] md:text-[16px] mt-[10px] xl:mt-[20px] drop-shadow-2xl rem2'>Leave a request on the site and get a 5 % discount on the first cleaning</p>
    </div>
    </div>
  </div>
  <div className="">
