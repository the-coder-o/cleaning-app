  ...
  return (
    <div className=' py-[80px] bg flex flex-col   md:pt-0 justify-center'>
        ...
        <div className="flex flex-wrap gap-2 mt-6 md:mt-12">
          <Badge className="drop-shadow-2xl shadow-black text-[14px]" variant={'outline'}>Locally Owned and Operated</Badge>
          <Badge className="drop-shadow-2xl shadow-black text-[14px]" variant={'outline'}>Truck-mounted state-of-the-art cleaning equipment</Badge>
          <Badge className="drop-shadow-2xl shadow-black text-[14px]" variant={'outline'}>Fully licensed and insured</Badge>
          <Badge className="drop-shadow-2xl shadow-black text-[14px]" variant={'outline'}>Non toxic products , safe for children & pets</Badge>
          <Badge className="drop-shadow-2xl shadow-black text-[14px]" variant={'outline'}>Over 23 years of experience</Badge>
          <Badge className="drop-shadow-2xl shadow-black text-[14px]" variant={'outline'}>Professional technicians</Badge>
          <Badge className="drop-shadow-2xl shadow-black text-[14px]" variant={'outline'}>Open 7 days a week</Badge>
          <Badge className="drop-shadow-2xl shadow-black text-[14px]" variant={'outline'}>Satisfaction guaranteed</Badge>
        </div>
      </div>
    </div>
  );
