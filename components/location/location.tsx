...
const Locations = () => {
  return (
    <div className='mt-28 space-y-24'>
        <div className=' flex items-center justify-evenly relative px-[10px] sm:p-0'>
        {/* left */}
        ...
        {/* left */}
        <div>
                <Image src={car_img} alt='location-img' className='z-0 lg:z-10  w-full max-w-[570px] h-[340px] sm:w-[300px] sm:h-[250px] md:w-[400px] md:h-[350px] lg:w-[460px] lg:h-[390px] xl:w-[540px] xl:h-[430px]' width={540} height={470}/>
            </div>
            
                  {/* right */}
            <div className='z-40 absolute sm:relative shadow-2xl bg-[#f5f5f5]/80 mx-[20px] w-[280px] h-[250px] sm:w-[320px]  sm:h-[250px] md:w-[390px] md:h-[350px] lg:w-[500px] lg:h-[390px] xl:w-[500px] xl:h-[430px] px-[20px] flex flex-col text-center justify-center items-center'>
                <h4 className='font-bold text-base sm:text-lg md:text-xl lg:text-3xl xl:text-5xl md:pb-[7px] montserrat'>Washington</h4>
                <center>    
                <div className='w-[200px] sm:w-[220px] md:w-[250px] lg:w-[290px] xl:w-[323px] h-[5px] bg-lime-400 border-s-3 mt-1 sm:mt-3'></div>
                </center>
